...
public class CardGame {
    private final List<Suits> SUITS = new ArrayList<>(Arrays.asList(Suits.SPADE, Suits.HEART, Suits.DIAMOND, Suits.CLUB));
    ...
    public void sortDeckInNumberOrder() {
        this.setDeckOfCards(this.getDeckOfCards().stream().sorted(Comparator.comparingInt(Card::getValue)).collect(Collectors.toList()));
    }

    public void sortDeckIntoSuits() {
        this.setDeckOfCards(this.getDeckOfCards().stream().sorted(Comparator.comparing(Card::getSuit)).collect(Collectors.toList()));
    }
